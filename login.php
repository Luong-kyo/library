...
// đăng nhập
    if(isset($_POST['login'])){
        ...
        if($taikhoan==''|| $matkhau==''){
            ...
            $sql_docgia = mysqli_query($connect,"SELECT * FROM docgia WHERE docgia_mail='$taikhoan' and docgia_mk='$matkhau' limit 1");
            $count = mysqli_num_rows($sql_docgia);
            $row_dangnhap=mysqli_fetch_array($sql_docgia);
            if($count>0){
                $_SESSION['login']=$row_dangnhap['docgia_ten'];
                $_SESSION['docgia_id']=$row_dangnhap['docgia_id'];
                        ...
                        <form class="card-body p-5 text-center" action="" method="POST">
                            ...
                            <div class="mb-md-5 mt-md-4 pb-5">
                                ...
                                <div class="form-outline form-white mb-4">
                                    ...
                                    <span><a href="forgetpass.php">Quên mật khẩu</a></span>
                                    <span>Chưa có tài khoản? <a href="signup.php">Đăng ký</a></span>
                                </div>
                                </div>
                                
                            <input type="submit" class="btn btn-outline-light btn-lg px-5"  name="login" value="Đăng nhập">
